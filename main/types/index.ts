...
export interface MLModelInfo {
  model_type: string; model_version: string; trained_at: string
  accuracy: number; f1_score_weighted: number; class_names: string[]
  feature_names: string[]; is_loaded: boolean
}
